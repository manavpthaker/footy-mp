 ...
 */
export function StatCard({ label, value, unit = null, accent = 'var(--text-primary)', style = {}, ...rest }) {
  return (
    <div
      style={{
    ...
    >
      ...
      <div style={{
        ...
        {value}
        {unit != null && <span style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-muted)', fontWeight: 'var(--fw-semibold)' }}>{unit}</span>}
      </div>
    </div>
  );
}
