 ...
 */
export function LeagueTable({ rows, onSelect, showForm = true, style = {}, ...rest }) {
  const th = {
            ...
            return (
              ...
              >
                <td style={{ ...td, fontFamily: 'var(--font-ui)', textAlign: 'left', paddingLeft: '9px', fontWeight: 'var(--fw-semibold)', whiteSpace: 'nowrap' }}>
                  <span style={{ display: 'inline-block', width: '19px', color: 'var(--text-faint)', fontSize: 'var(--fs-2xs)', fontFamily: 'var(--font-mono)' }}>{r.pos != null ? r.pos : i + 1}</span>
